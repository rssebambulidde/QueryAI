 ...
 * Since the 'admin' role has been removed, this is the only admin-level guard.
 */
...
/**
 * @deprecated Use isSuperAdmin instead. The 'admin' role has been removed.
 */
export const isAdminOrSuperAdmin = isSuperAdmin;
