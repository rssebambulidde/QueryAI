  ...
  if (variant === 'banner') {
    return (
      <div className="mx-auto max-w-3xl px-4 mb-4">
        <div className="flex items-center gap-3 rounded-xl border border-blue-100 bg-blue-50/60 px-4 py-3 text-sm">
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <Link href="/login">
              <Button variant="ghost" size="sm" className="text-blue-600 hover:text-blue-700 hover:bg-blue-100 h-8 px-3">
                Sign in
              </Button>
            </Link>
            <Link href="/signup">
          ...
          {onDismiss && (
            <button
              onClick={onDismiss}
              className="text-gray-400 hover:text-gray-600 p-1 rounded-md hover:bg-blue-100 transition-colors"
              aria-label="Dismiss"
            >
