...
import { useValidation, useTestRun } from '@/lib/hooks/use-validation';
...
import { ValidationTestSuite, ValidationRun } from '@/lib/api-validation';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-xl font-semibold text-gray-900">Validation Reports</h3>
